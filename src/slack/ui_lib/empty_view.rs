use super::{
    any_view::AnySlackView, blocks::_SlackBlocksCollection, primitive_view::PrimitiveView,
...
impl SlackView for EmptySlackView {
    fn __push_blocks_into(&self, _: &mut _SlackBlocksCollection)
    where
        Self: Sized,
    {
    }
...
mod tests {
    use crate::slack::ui_lib::{
        block_kit_views::SlackSection, slack_view::SlackView, test_support::assert_blocks_json,
    };
