...
mod tests {
    ...
    use crate::slack::ui_lib::{
        block_kit_views::SlackDivider, flat_chain_view::_FlatChainSlackView, slack_view::SlackView,
        test_support::assert_blocks_json,
    };
    ...
    fn excluded_block_when_nested_value_not_present() {
        assert_blocks_json(
            &None::<_FlatChainSlackView<SlackDivider, SlackDivider>>,
            r#"[]"#,
        )
    }
}
